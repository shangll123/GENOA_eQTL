...
snp_annot$effectAllele = as.character(snp_annot$allele0)
  ...
  # Prepare output data----
  model_summary_file <- paste0('/net/mulan/home/shanglu/GENOA/analysis/prediction/predixcan/EA/chr_',i_index, "/EA" , '_chr_' ,i_index,'_gene_', j_index, '_model_summaries.txt')
  ...
  weights_file <- paste0('/net/mulan/home/shanglu/GENOA/analysis/prediction/predixcan/EA/chr_',i_index,'/EA_chr_',i_index,'_gene_',j_index,'.txt')
  
  weights_col <- c('gene_id', 'rsid', 'varID', 'ref', 'alt', 'beta')
  write(weights_col, file = weights_file, ncol = 6, sep = '\t')
  
 tiss_chr_summ_f <- paste0('/net/mulan/home/shanglu/GENOA/analysis/prediction/predixcan/EA/chr_',i_index,'/EA_chr_',i_index,'_gene_',j_index,'_summary.txt')
  ...
  covariance_file <- paste0('/net/mulan/home/shanglu/GENOA/analysis/prediction/predixcan/EA/chr_',i_index,'/EA_chr_',i_index,'_gene_',j_index,'_covariance.txt')
...
```
#!/bin/bash
#SBATCH --job-name=EApred
#SBATCH --array=1-66
#SBATCH --cpus-per-task=1
#SBATCH --output=/net/mulan/home/shanglu/GENOA/data/EA/out/EApred%a.out
#SBATCH --error=/net/mulan/home/shanglu/GENOA/data/EA/err/EApred%a.err
#SBATCH --workdir=/net/mulan/home/shanglu/GENOA/analysis/EA/eqtlmapping/code
#SBATCH --partition=mulan
...
do
alpha=0.05
Rscript ./EA_elastic_net_fromMESA.r $i $j $alpha
done
fi
let k=${k}+1
if [ ${k} -eq ${SLURM_ARRAY_TASK_ID} ]; then
